#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
#--- https://github.com/licapLaboratory/Extreme-Outliers
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
...
path <- 'D:/TEMP/licapLaboratory/'
setwd(path)

# LOADING LIBRARIES AND PACKAGES

loadLibrary <- function(){
  #source("D:/BACKUP/Acadêmico/Doutorado/Time Series Extreme GEV/SyTSBox.R")
  packs <- c("readr","tidyverse","caret",
             "gtools","DescTools", #"tstools",
             "extRemes","ismev","evd","forecast",
             "entropy","cluster","factoextra","fpc", #"clusternor", 
             "Hotelling","mltest","exptest", "goft")
